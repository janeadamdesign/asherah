...
export const menuContent: MenuContent = {
  appetisers: {
    ...
    5: {
      ...
      copy: "Mini falafel patties served on a dollop of Greek tzatziki, garnished with dill and pomegranate seeds.",
      price: 8.5,
    },
    6: {
    ...
    7: {
      ...
      copy: "Grilled halloumi and fresh figs on skewers, drizzled with a balsamic reduction and sprinkled with crushed pistachios, blending Greek and Middle Eastern flavors.",
      price: 11,
    },
    8: {
  ...
  entrees: {
    1: {
      ...
      copy: "Skewers of lamb, chicken, and beef marinated in a mixture of pomegranate molasses, Greek yogurt, and Arabic spices, grilled to perfection. Served with a side of tabbouleh and tzatziki.",
      price: 22,
    },
    2: {
    ...
    6: {
      ...
      copy: "A hearty tagine featuring chunks of swordfish and shrimp, potatoes, and olives, simmered in a saffron broth, served with flatbread.",
      price: 22,
    },
    7: {
    ...
    9: {
      ...
      copy: "Slices of halloumi and seasonal vegetables served on a cedar plank with a garlic and herb labneh dip.",
      price: 15,
    },
  },
  sweets: {
